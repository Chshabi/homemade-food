package uo.nexton.foodator.adapters;
...
import uo.nexton.foodator.activities.ProductDetailsActivity;
...
public class ProductsAdapter extends FirebaseRecyclerAdapter<Products, ProductsAdapter.myviewholder> {
    public ProductsAdapter(@NonNull FirebaseRecyclerOptions<Products> options) {
        super(options);
    }
